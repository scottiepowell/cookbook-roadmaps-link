...
| Local live importer diagnostics | Pass | offline sanitizer tests plus runbook diagnostic and dedicated importer smoke script | Uses a deterministic tiny fixture and accepted 300-token bounded profile; full-RAG importer evaluation keeps its separate larger manual cap. |
